...
public class ApiProductController {
    ...
    @PostMapping
    public ResponseEntity<ApiProductDto> createProduct(@RequestBody ApiProductCreateDto createDto) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiProductDto> getProductById(@PathVariable Integer id) {
    ...
    public ResponseEntity<ApiProductDto> updateProduct(
            ...
            @RequestBody ApiProductDto updateDto) {
